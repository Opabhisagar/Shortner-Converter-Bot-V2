...
START_MESSAGE = '''**Hello, {}
I Am Mdiskshortner.in, Bulk Link Converter. I Can Convert Links Directly From Your Mdiskshortner.in Account,
    
1. Go To 👉 https://Mdiskshortner.in/member/tools/api  
2. Than Copy API Key
...
If You Want Any **Other Shortner** Link Converter Bot Instead Of Mdiskshortner than **contact** at 👉 @opabhisagar (all **shortners** support available.)
'''

HELP_MESSAGE = '''**Hello, {}
I Am Mdiskshortner, Bulk Link Converter Bot. I Can Convert Links Directly From Your Mdiskshortner Account,**
...
If You Want Any **Other Shortner** Link Converter Bot Instead Of ""Mdiskshortner** than **contact** at 👉 @Cyniteofficial (all **shortners support** available.)**
'''

ABOUT_TEXT = '''**Hey! My name is @opmoviehubBot. I am Mdisk Link Converter Bot.**
...
• **No** need to share **password or email** to convert links.**
 ...
 Anyone who want to use any **other shortner** instead of Mdiskshortner than **contact** at 👉 @Cyniteofficial (all **shortners support** available.)
